...
const DappTokenWhitelistedCrowdsale= artifacts.require('DappTokenWhitelistedCrowdsale');
const DappToken= artifacts.require('DappToken');
const RefundVault = artifacts.require('./RefundVault');

contract('DappTokenWhitelistedCrowdsale', function([owner1, wallet, investor1, investor2, investor5]) {
...
this.crowdsale= await DappTokenWhitelistedCrowdsale.new(
    this.rate,
    this.wallet,
    this.token.address,
    this.cap,
...
describe('refundable crowdsale', ()=>{
    ...
    describe('during crowdsale', ()=>{
        it('prevents to claim funds during crowdsale', async function(){
          const tx=  await this.vault.refund(investor2, {from: investor2});
   // console.log( tx);   
    })
    })
})
