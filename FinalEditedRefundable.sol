...
contract DappTokenRefundableCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, RefundableCrowdsale, WhitelistedCrowdsale {
...
require( _goal <= _cap);
  ...
  function _preValidatePurchase(
    ...
    internal
    override(Crowdsale,CappedCrowdsale,TimedCrowdsale,WhitelistedCrowdsale)
  {
    super._preValidatePurchase(_beneficiary, _weiAmount);
